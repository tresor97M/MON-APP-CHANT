...
const QUIZZES = [
  ...
  { id: 3, title: 'GitHub Basics', course: 'Respiration & Soutien', thumb: 'R', questions: 5, status: 'draft' },
];
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Gérez les quiz de vos cours.</p>
        </div>
        <Link href="/instructor/quiz/nouveau"
          ...
          <PlusCircle className="w-4 h-4" /> Add Quiz
        </Link>
      </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1.5">
                  ...
                  )}>{q.status === 'active' ? 'Actif' : 'Brouillon'}</span>
                </div>
              </div>
              <div className="flex items-center gap-2 shrink-0">
                <Link href={`/instructor/quiz/${q.id}/review`} className="p-1.5 rounded-lg hover:bg-muted transition-colors text-muted-foreground hover:text-primary"><Eye className="w-4 h-4" /></Link>
                <Link href="/instructor/quiz/nouveau" className="p-1.5 rounded-lg hover:bg-muted transition-colors text-muted-foreground hover:text-primary"><Edit2 className="w-4 h-4" /></Link>
